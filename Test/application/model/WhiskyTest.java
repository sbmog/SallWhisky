...
class WhiskyTest {
    ...
    void getHistorik() {
        ...
        Destillat destillat = new Destillat("D001", LocalDate.of(2023, 6, 1), LocalDate.of(2023, 6, 30), 10, 60.0, true, 100, maltBatch);

        // Opret et fad og påfyldning
        Fad fad = new Fad(1, 200, "Eg", "Leverandør A", 1, new FadType("Sherry"), null);
        Påfyldning påfyldning = new Påfyldning("AB", 100, LocalDate.of(2020, 7, 1), fad, destillat);
